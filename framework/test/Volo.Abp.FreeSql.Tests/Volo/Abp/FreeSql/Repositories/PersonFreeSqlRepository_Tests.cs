...
public class PersonFreeSqlRepository_Tests : FreeSqlTestBase
{
    [Fact]
    public async Task GetAllPersonNames_Test()
    {
        var allNames = await GetRequiredService<PersonFreeSqlRepository>().GetAllPersonNames();
    ...
    {
        var personDapperRepository = GetRequiredService<PersonFreeSqlRepository>();
